...
function chartjsLineChartForcast(
  selector,
  label = "",
  startGradient = "#6C9B2212",
  endGradient = "#6C9B2202",
  bColor = "#238636",
      ...
      var chart = new Chart(elm, {
        ...
        data: {
          ...
          datasets: [{
            ...
            // backgroundColor: bgColor,
            borderColor: bColor,
            pointHoverBackgroundColor: "#6C9B22",
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
            data: dataG,
            backgroundColor: "#6C9B2280",
            hoverBackgroundColor: "#6C9B22",
            label: "Gained",
          },
          // {
          //   data: dataL,
...
chartJsBarChartThree("mychart8", "#6C9B2220", "#6C9B22", "Order");
...
chartJsBarChartFour("mychart13", "#6C9B2220", "#6C9B22", "New Deals");
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          data: data,
          backgroundColor: ["#238636", "#6C9B22", "#FA8B0C"],
          total: "9,283",
        }, ],
      },
      options: {
