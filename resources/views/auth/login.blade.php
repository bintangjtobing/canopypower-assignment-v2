...
<head>
    <title>Canopy Power - Authentication</title>
    <meta charset="UTF-8">
    ...
    <meta name="description" content="Canopy power assignment web developer">
            ...
            <div class="wrap-login100">
                ...
                <form action="/login/{{$tokens}}" method="POST" class="login100-form validate-form">
                    ...
                    <span class="login100-form-title p-b-16">
                        Welcome to<br>Canopy Power
                    </span>
                    <span class="login100-form-title p-b-40">
                        <img src="{!!asset('favicon.ico')!!}" alt="Canopy Power Authentication">
                    </span>
